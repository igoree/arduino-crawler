...
typedef enum
{
    ...
    E_ULTRASONIC_AVOIDANCE = 4,
    // E_PS2_REMOTE_CONTROL,
    E_NRF24L01_CONTROL = 5,
    E_ULTRASONIC_INFRARED_AVOIDANCE = 6,
    E_PIANO_MODE = 7,
    E_RGB_MODE = 8,
    E_LED_MAXTRIX_MODE = 9,
    E_CMD_LINE_MODE = 10,
    E_LIGHT_SEEKING_MODE = 11,
    E_ULTRASONIC_FOLLOW_MODE = 12,
    E_SMARTCAR_CONTROL_MAX = 13,
